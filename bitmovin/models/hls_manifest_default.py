...
class HlsManifestDefault(HlsManifest):
    ...
    def openapi_types(self):
        types = super(HlsManifestDefault, self).openapi_types
        types.update({
            'encoding_id': 'str',
    ...
    def attribute_map(self):
        attributes = super(HlsManifestDefault, self).attribute_map
        attributes.update({
    ...
    def __init__(self, encoding_id=None, version=None, *args, **kwargs):
        super(HlsManifestDefault, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(HlsManifestDefault, dict):
