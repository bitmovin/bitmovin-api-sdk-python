...
class AkamaiNetStorageOutput(Output):
    ...
    def openapi_types(self):
        types = super(AkamaiNetStorageOutput, self).openapi_types
        types.update({
            'host': 'str',
            'username': 'str',
            'password': 'str'
    ...
    def attribute_map(self):
        attributes = super(AkamaiNetStorageOutput, self).attribute_map
        attributes.update({
            'host': 'host',
            'username': 'username',
            'password': 'password'
    ...
    def __init__(self, host=None, username=None, password=None, *args, **kwargs):
        super(AkamaiNetStorageOutput, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(AkamaiNetStorageOutput, dict):
