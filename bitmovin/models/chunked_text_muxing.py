...
class ChunkedTextMuxing(Muxing):
    ...
    def openapi_types(self):
        types = super(ChunkedTextMuxing, self).openapi_types
        types.update({
    ...
    def attribute_map(self):
        attributes = super(ChunkedTextMuxing, self).attribute_map
        attributes.update({
    ...
    def __init__(self, segment_length=None, segment_naming=None, segment_naming_template=None, segments_muxed=None, *args, **kwargs):
        super(ChunkedTextMuxing, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(ChunkedTextMuxing, dict):
