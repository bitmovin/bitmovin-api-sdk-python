...
class TtmlEmbed(BitmovinResource):
    ...
    def openapi_types(self):
        types = super(TtmlEmbed, self).openapi_types
        types.update({
    ...
    def attribute_map(self):
        attributes = super(TtmlEmbed, self).attribute_map
        attributes.update({
    ...
    def __init__(self, input_stream=None, *args, **kwargs):
        super(TtmlEmbed, self).__init__(*args, **kwargs)
