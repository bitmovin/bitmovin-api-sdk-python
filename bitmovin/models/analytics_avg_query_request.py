...
class AnalyticsAvgQueryRequest(AnalyticsQueryRequest):
    def __init__(self, *args, **kwargs):
        super(AnalyticsAvgQueryRequest, self).__init__(*args, **kwargs)
        self.discriminator = None
    def to_dict(self):
        """Returns the model properties as a dict"""
        result = super(AnalyticsAvgQueryRequest, self).to_dict()
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(AnalyticsAvgQueryRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnalyticsAvgQueryRequest):
            return False
