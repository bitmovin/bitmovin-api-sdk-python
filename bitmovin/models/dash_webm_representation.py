...
class DashWebmRepresentation(DashSegmentedRepresentation):
    def __init__(self, *args, **kwargs):
        super(DashWebmRepresentation, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(DashWebmRepresentation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashWebmRepresentation):
            return False
