...
class WidevineDrm(Drm):
    ...
    def openapi_types(self):
        types = super(WidevineDrm, self).openapi_types
        types.update({
            'key': 'str',
            'kid': 'str',
            'pssh': 'str'
    ...
    def attribute_map(self):
        attributes = super(WidevineDrm, self).attribute_map
        attributes.update({
            'key': 'key',
            'kid': 'kid',
            'pssh': 'pssh'
    ...
    def __init__(self, key=None, kid=None, pssh=None, *args, **kwargs):
        super(WidevineDrm, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(WidevineDrm, dict):
