...
class DashFmp4DrmRepresentation(DashFmp4Representation):
    ...
    def openapi_types(self):
        types = super(DashFmp4DrmRepresentation, self).openapi_types
        types.update({
            'drm_id': 'str'
        })
        return types
    ...
    def attribute_map(self):
        attributes = super(DashFmp4DrmRepresentation, self).attribute_map
        attributes.update({
            'drm_id': 'drmId'
        })
        return attributes
    ...
    def __init__(self, drm_id=None, *args, **kwargs):
        super(DashFmp4DrmRepresentation, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(DashFmp4DrmRepresentation, dict):
