...
class Mp2AudioConfiguration(AudioConfiguration):
    ...
    def openapi_types(self):
        types = super(Mp2AudioConfiguration, self).openapi_types
        types.update({
    ...
    def attribute_map(self):
        attributes = super(Mp2AudioConfiguration, self).attribute_map
        attributes.update({
            'channel_layout': 'channelLayout'
        })
        return attributes
    ...
    def __init__(self, channel_layout=None, *args, **kwargs):
        super(Mp2AudioConfiguration, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(Mp2AudioConfiguration, dict):
