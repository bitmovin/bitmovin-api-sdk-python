...
class GenericS3Output(Output):
    ...
    def openapi_types(self):
        types = super(GenericS3Output, self).openapi_types
        types.update({
            'access_key': 'str',
            'secret_key': 'str',
            'bucket_name': 'str',
    ...
    def attribute_map(self):
        attributes = super(GenericS3Output, self).attribute_map
        attributes.update({
    ...
    def __init__(self, access_key=None, secret_key=None, bucket_name=None, host=None, port=None, ssl=None, signature_version=None, *args, **kwargs):
        super(GenericS3Output, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(GenericS3Output, dict):
