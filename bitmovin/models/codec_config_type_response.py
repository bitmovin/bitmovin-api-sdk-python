...
class CodecConfigTypeResponse(object):
    """
    Attributes:
    ...
    def type(self):
        ...
        :return: The type of this CodecConfigTypeResponse.
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CodecConfigTypeResponse.

        The type of the codec config

        :param type: The type of this CodecConfigTypeResponse.
        :type: CodecConfigType
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(CodecConfigTypeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CodecConfigTypeResponse):
            return False
