...
class TextMuxing(Muxing):
    ...
    def openapi_types(self):
        types = super(TextMuxing, self).openapi_types
        types.update({
            'filename': 'str'
        })
        return types
    ...
    def attribute_map(self):
        attributes = super(TextMuxing, self).attribute_map
        attributes.update({
            'filename': 'filename'
        })
        return attributes
    ...
    def __init__(self, filename=None, *args, **kwargs):
        super(TextMuxing, self).__init__(*args, **kwargs)
