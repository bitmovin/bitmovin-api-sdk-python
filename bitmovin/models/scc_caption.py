...
class SccCaption(BitmovinResource):
    ...
    def openapi_types(self):
        types = super(SccCaption, self).openapi_types
        types.update({
            'input': 'InputPath'
        })
        return types
    ...
    def attribute_map(self):
        attributes = super(SccCaption, self).attribute_map
        attributes.update({
            'input': 'input'
        })
        return attributes
    ...
    def __init__(self, input=None, *args, **kwargs):
        super(SccCaption, self).__init__(*args, **kwargs)
