...
class HttpInput(Input):
    ...
    def openapi_types(self):
        types = super(HttpInput, self).openapi_types
        types.update({
            'host': 'str',
            'username': 'str',
            'password': 'str',
    ...
    def attribute_map(self):
        attributes = super(HttpInput, self).attribute_map
        attributes.update({
            'host': 'host',
            'username': 'username',
            'password': 'password',
    ...
    def __init__(self, host=None, username=None, password=None, port=None, *args, **kwargs):
        super(HttpInput, self).__init__(*args, **kwargs)
