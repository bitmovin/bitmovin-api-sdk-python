...
class HeAacV1AudioConfiguration(AudioConfiguration):
    ...
    def openapi_types(self):
        types = super(HeAacV1AudioConfiguration, self).openapi_types
        types.update({
    ...
    def attribute_map(self):
        attributes = super(HeAacV1AudioConfiguration, self).attribute_map
        attributes.update({
    ...
    def __init__(self, channel_layout=None, *args, **kwargs):
        super(HeAacV1AudioConfiguration, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(HeAacV1AudioConfiguration, dict):
