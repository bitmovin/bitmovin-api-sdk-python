...
class SubtitleStream(MediaStream):
    ...
    def openapi_types(self):
        types = super(SubtitleStream, self).openapi_types
        types.update({
            'language': 'str',
    ...
    def attribute_map(self):
        attributes = super(SubtitleStream, self).attribute_map
        attributes.update({
            'language': 'language',
    ...
    def __init__(self, language=None, hearing_impaired=None, *args, **kwargs):
        super(SubtitleStream, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(SubtitleStream, dict):
