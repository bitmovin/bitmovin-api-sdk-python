...
class AnalyticsMinQueryRequest(AnalyticsQueryRequest):
    def __init__(self, *args, **kwargs):
        super(AnalyticsMinQueryRequest, self).__init__(*args, **kwargs)
        self.discriminator = None
    def to_dict(self):
        """Returns the model properties as a dict"""
        result = super(AnalyticsMinQueryRequest, self).to_dict()
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(AnalyticsMinQueryRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AnalyticsMinQueryRequest):
            return False
