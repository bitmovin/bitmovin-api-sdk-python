...
class SftpOutput(Output):
    ...
    def openapi_types(self):
        types = super(SftpOutput, self).openapi_types
        types.update({
            'host': 'str',
            'port': 'int',
            'passive': 'bool',
    ...
    def attribute_map(self):
        attributes = super(SftpOutput, self).attribute_map
        attributes.update({
            'host': 'host',
            'port': 'port',
            'passive': 'passive',
    ...
    def __init__(self, host=None, port=None, passive=None, username=None, password=None, transfer_version=None, max_concurrent_connections=None, *args, **kwargs):
        super(SftpOutput, self).__init__(*args, **kwargs)
