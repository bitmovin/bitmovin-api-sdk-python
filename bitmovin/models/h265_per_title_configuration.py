...
class H265PerTitleConfiguration(PerTitleConfiguration):
    ...
    def openapi_types(self):
        types = super(H265PerTitleConfiguration, self).openapi_types
        types.update({
    ...
    def attribute_map(self):
        attributes = super(H265PerTitleConfiguration, self).attribute_map
        attributes.update({
    ...
    def __init__(self, target_quality_crf=None, codec_min_bitrate_factor=None, codec_max_bitrate_factor=None, codec_bufsize_factor=None, *args, **kwargs):
        super(H265PerTitleConfiguration, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(H265PerTitleConfiguration, dict):
