...
class VorbisAudioConfiguration(AudioConfiguration):
    ...
    def openapi_types(self):
        types = super(VorbisAudioConfiguration, self).openapi_types
        types.update({
    ...
    def attribute_map(self):
        attributes = super(VorbisAudioConfiguration, self).attribute_map
        attributes.update({
    ...
    def __init__(self, channel_layout=None, *args, **kwargs):
        super(VorbisAudioConfiguration, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(VorbisAudioConfiguration, dict):
