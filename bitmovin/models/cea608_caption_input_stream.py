...
class Cea608CaptionInputStream(InputStream):
    ...
    def openapi_types(self):
        types = super(Cea608CaptionInputStream, self).openapi_types
        types.update({
            'input_id': 'str',
            'input_path': 'str',
    ...
    def attribute_map(self):
        attributes = super(Cea608CaptionInputStream, self).attribute_map
        attributes.update({
            'input_id': 'inputId',
    ...
    def __init__(self, input_id=None, input_path=None, channel=None, *args, **kwargs):
        super(Cea608CaptionInputStream, self).__init__(*args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.openapi_types):
            ...
            if issubclass(Cea608CaptionInputStream, dict):
