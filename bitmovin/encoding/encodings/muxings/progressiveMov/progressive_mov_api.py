...
from bitmovin.encoding.encodings.muxings.progressiveMov.progressive_mov_muxing_list_query_params import ProgressiveMovMuxingListQueryParams
...
class ProgressiveMovApi(BaseApi):
    ...
    def list(self, encoding_id, query_params: ProgressiveMovMuxingListQueryParams = None, **kwargs):
