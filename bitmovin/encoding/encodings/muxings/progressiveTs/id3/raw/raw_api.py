...
from bitmovin.encoding.encodings.muxings.progressiveTs.id3.raw.raw_id3_tag_list_query_params import RawId3TagListQueryParams
...
class RawApi(BaseApi):
    ...
    def list(self, encoding_id, muxing_id, query_params: RawId3TagListQueryParams = None, **kwargs):
