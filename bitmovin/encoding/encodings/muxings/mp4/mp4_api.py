...
from bitmovin.encoding.encodings.muxings.mp4.mp4_muxing_list_query_params import Mp4MuxingListQueryParams
...
class Mp4Api(BaseApi):
    ...
    def list(self, encoding_id, query_params: Mp4MuxingListQueryParams = None, **kwargs):
        """List MP4 Muxings"""
