...
from bitmovin.encoding.encodings.muxings.fmp4.drm.primetime.prime_time_drm_list_query_params import PrimeTimeDrmListQueryParams
...
class PrimetimeApi(BaseApi):
    ...
    def list(self, encoding_id, muxing_id, query_params: PrimeTimeDrmListQueryParams = None, **kwargs):
