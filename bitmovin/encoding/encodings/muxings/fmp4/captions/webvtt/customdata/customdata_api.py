...
class CustomdataApi(BaseApi):
    ...
    def getCustomData(self, encoding_id, muxing_id, captions_id, **kwargs):
        """Get FMP4 Embed WebVtt Captions Custom Data"""

        return self.api_client.get(
            '/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/captions/webvtt/{captions_id}/customData',
