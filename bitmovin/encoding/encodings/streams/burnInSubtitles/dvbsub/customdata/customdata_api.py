...
class CustomdataApi(BaseApi):
    ...
    def getCustomData(self, encoding_id, stream_id, subtitle_id, **kwargs):
        """Get Burn-In DVB-SUB Subtitle Custom Data"""

        return self.api_client.get(
            '/encoding/encodings/{encoding_id}/streams/{stream_id}/burn-in-subtitles/dvbsub/{subtitle_id}/customData',
