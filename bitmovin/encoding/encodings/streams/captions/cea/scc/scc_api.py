...
from bitmovin.encoding.encodings.streams.captions.cea.scc.scc_caption_list_query_params import SccCaptionListQueryParams
...
class SccApi(BaseApi):
    ...
    def list(self, encoding_id, stream_id, query_params: SccCaptionListQueryParams = None, **kwargs):
