...
from bitmovin.encoding.encodings.captions.extract.ttml.ttml_extract_list_query_params import TtmlExtractListQueryParams
...
class TtmlApi(BaseApi):
    ...
    def create(self, encoding_id, ttml_extract, **kwargs):
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/captions/extract/ttml',
            ttml_extract,
    ...
    def delete(self, encoding_id, captions_id, **kwargs):
        ...
        return self.api_client.delete(
            '/encoding/encodings/{encoding_id}/captions/extract/ttml/{captions_id}',
