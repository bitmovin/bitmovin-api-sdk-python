...
from bitmovin.encoding.encodings.captions.extract.cea.captions_cea_list_query_params import CaptionsCeaListQueryParams
...
class CeaApi(BaseApi):
    ...
    def create(self, encoding_id, captions_cea, **kwargs):
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/captions/extract/cea',
            captions_cea,
    ...
    def delete(self, encoding_id, captions_id, **kwargs):
        ...
        return self.api_client.delete(
            '/encoding/encodings/{encoding_id}/captions/extract/cea/{captions_id}',
