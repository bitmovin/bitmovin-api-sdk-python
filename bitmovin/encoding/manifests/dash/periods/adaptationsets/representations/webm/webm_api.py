...
from bitmovin.encoding.manifests.dash.periods.adaptationsets.representations.webm.dash_webm_representation_list_query_params import DashWebmRepresentationListQueryParams
...
class WebmApi(BaseApi):
    ...
    def list(self, manifest_id, period_id, adaptationset_id, query_params: DashWebmRepresentationListQueryParams = None, **kwargs):
