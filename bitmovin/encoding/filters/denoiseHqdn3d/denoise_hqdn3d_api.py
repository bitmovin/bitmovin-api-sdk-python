...
from bitmovin.encoding.filters.denoiseHqdn3d.denoise_hqdn3d_filter_list_query_params import DenoiseHqdn3dFilterListQueryParams
...
class DenoiseHqdn3dApi(BaseApi):
    ...
    def list(self, query_params: DenoiseHqdn3dFilterListQueryParams = None, **kwargs):
