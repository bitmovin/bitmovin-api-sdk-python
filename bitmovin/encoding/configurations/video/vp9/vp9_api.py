...
from bitmovin.encoding.configurations.video.vp9.vp9_video_configuration_list_query_params import Vp9VideoConfigurationListQueryParams
...
class Vp9Api(BaseApi):
    ...
    def list(self, query_params: Vp9VideoConfigurationListQueryParams = None, **kwargs):
