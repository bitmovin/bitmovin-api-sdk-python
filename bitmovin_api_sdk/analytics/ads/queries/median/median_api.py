...
class MedianApi(BaseApi):
    ...
    def create(self, ad_analytics_median_query_request, **kwargs):
        # type: (AdAnalyticsMedianQueryRequest, dict) -> AnalyticsResponse
        """Median

        :param ad_analytics_median_query_request: Analytics Query Object
        :type ad_analytics_median_query_request: AdAnalyticsMedianQueryRequest, required
        :return: Service specific result
        :rtype: AnalyticsResponse
        """

        return self.api_client.post(
            '/analytics/ads/queries/median',
            ad_analytics_median_query_request,
