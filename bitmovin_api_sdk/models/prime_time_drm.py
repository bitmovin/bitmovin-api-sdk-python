...
class PrimeTimeDrm(Drm):
    ...
    def __init__(self,
        ...
        super(PrimeTimeDrm, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, outputs=outputs)
