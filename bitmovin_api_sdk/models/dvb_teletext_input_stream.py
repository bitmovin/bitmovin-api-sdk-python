...
class DvbTeletextInputStream(InputStream):
    ...
    def __init__(self,
                 ...
                 position=None,
                 page=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, string_types, string_types, StreamSelectionMode, int, int) -> None
        super(DvbTeletextInputStream, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(DvbTeletextInputStream, self), 'openapi_types'):
            types = getattr(super(DvbTeletextInputStream, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(DvbTeletextInputStream, self), 'attribute_map'):
            attributes = getattr(super(DvbTeletextInputStream, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(DvbTeletextInputStream, self), "to_dict"):
