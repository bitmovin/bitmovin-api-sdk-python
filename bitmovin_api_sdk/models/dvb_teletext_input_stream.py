...
class DvbTeletextInputStream(InputStream):
    ...
    def __init__(self,
                 ...
                 position=None,
                 page=None):
        # type: (string_types, string_types, string_types, datetime, datetime, dict, string_types, string_types, StreamSelectionMode, int, int) -> None
        super(DvbTeletextInputStream, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data)
