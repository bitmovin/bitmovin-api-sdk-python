...
class PlaintextId3Tag(Id3Tag):
    ...
    def __init__(self,
                 ...
                 text=None,
                 frame_id=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, Id3TagPositionMode, int, float, string_types, string_types) -> None
        super(PlaintextId3Tag, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, position_mode=position_mode, frame=frame, time=time)
