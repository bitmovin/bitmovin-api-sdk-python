...
class HeAacV2AudioConfiguration(AudioConfiguration):
    ...
    def __init__(self,
                 ...
                 channel_layout=None,
                 signaling=None):
        # type: (string_types, string_types, string_types, datetime, datetime, dict, int, float, AacChannelLayout, HeAacV2Signaling) -> None
        super(HeAacV2AudioConfiguration, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, bitrate=bitrate, rate=rate)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(HeAacV2AudioConfiguration, self), 'openapi_types'):
            types = getattr(super(HeAacV2AudioConfiguration, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(HeAacV2AudioConfiguration, self), 'attribute_map'):
            attributes = getattr(super(HeAacV2AudioConfiguration, self), 'attribute_map')
    ...
    def signaling(self, signaling):
        ...
        if signaling is not None:
            if not isinstance(signaling, HeAacV2Signaling):
                raise TypeError("Invalid type for `signaling`, type has to be `HeAacV2Signaling`")
    ...
    def to_dict(self):
        ...
        if hasattr(super(HeAacV2AudioConfiguration, self), "to_dict"):
