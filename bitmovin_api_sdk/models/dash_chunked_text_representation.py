...
class DashChunkedTextRepresentation(DashSegmentedRepresentation):

    def to_dict(self):
        """Returns the model properties as a dict"""
        result = {}

        if hasattr(super(DashChunkedTextRepresentation, self), "to_dict"):
            result = super(DashChunkedTextRepresentation, self).to_dict()
        return result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashChunkedTextRepresentation):
            return False
