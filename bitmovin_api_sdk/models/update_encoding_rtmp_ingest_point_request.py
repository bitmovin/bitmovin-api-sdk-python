...
class UpdateEncodingRtmpIngestPointRequest(object):
    @poscheck_model
    def __init__(self,
                 ingest_points=None):
        # type: (list[RtmpIngestPoint]) -> None
    ...
    def ingest_points(self):
        ...
        """Gets the ingest_points of this UpdateEncodingRtmpIngestPointRequest.
        ...
        :return: The ingest_points of this UpdateEncodingRtmpIngestPointRequest.
    ...
    def ingest_points(self, ingest_points):
        # type: (list) -> None
        """Sets the ingest_points of this UpdateEncodingRtmpIngestPointRequest.

        List of ingest points to be updated for the encoding. The RTMPs application name and streamKey will be assigned to the encoding. 

        :param ingest_points: The ingest_points of this UpdateEncodingRtmpIngestPointRequest.
        :type: list[RtmpIngestPoint]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateEncodingRtmpIngestPointRequest):
            return False
