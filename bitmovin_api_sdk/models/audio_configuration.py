...
class AudioConfiguration(CodecConfiguration):
    ...
    def __init__(self,
                 ...
                 bitrate=None,
                 rate=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, int, float) -> None
        super(AudioConfiguration, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
