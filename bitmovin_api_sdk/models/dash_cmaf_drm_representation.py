...
class DashCmafDrmRepresentation(DashCmafRepresentation):
    ...
    def __init__(self,
        ...
        super(DashCmafDrmRepresentation, self).__init__(id_=id_, encoding_id=encoding_id, muxing_id=muxing_id, dependency_id=dependency_id, type_=type_, mode=mode, segment_path=segment_path, start_segment_number=start_segment_number, end_segment_number=end_segment_number, start_keyframe_id=start_keyframe_id, end_keyframe_id=end_keyframe_id)
