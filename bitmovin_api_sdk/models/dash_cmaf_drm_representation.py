...
class DashCmafDrmRepresentation(DashCmafRepresentation):
    ...
    def __init__(self,
        ...
        super(DashCmafDrmRepresentation, self).__init__(id_=id_, encoding_id=encoding_id, muxing_id=muxing_id, type_=type_, mode=mode, segment_path=segment_path, start_segment_number=start_segment_number, end_segment_number=end_segment_number, start_keyframe_id=start_keyframe_id, end_keyframe_id=end_keyframe_id)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(DashCmafDrmRepresentation, self), 'openapi_types'):
            types = getattr(super(DashCmafDrmRepresentation, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(DashCmafDrmRepresentation, self), 'attribute_map'):
            attributes = getattr(super(DashCmafDrmRepresentation, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(DashCmafDrmRepresentation, self), "to_dict"):
