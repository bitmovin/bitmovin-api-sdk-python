...
class WebmMuxing(Muxing):
    ...
    def __init__(self,
                 ...
                 segments_muxed=None):
        # type: (string_types, string_types, string_types, datetime, datetime, dict, list[MuxingStream], list[EncodingOutput], int, int, int, list[Ignoring], StreamConditionsMode, float, string_types, string_types, string_types, string_types, int) -> None
        super(WebmMuxing, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, streams=streams, outputs=outputs, avg_bitrate=avg_bitrate, min_bitrate=min_bitrate, max_bitrate=max_bitrate, ignored_by=ignored_by, stream_conditions_mode=stream_conditions_mode)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(WebmMuxing, self), 'openapi_types'):
            types = getattr(super(WebmMuxing, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(WebmMuxing, self), 'attribute_map'):
            attributes = getattr(super(WebmMuxing, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(WebmMuxing, self), "to_dict"):
