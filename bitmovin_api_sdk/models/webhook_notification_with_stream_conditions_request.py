...
class WebhookNotificationWithStreamConditionsRequest(WebhookNotification):
    ...
    def __init__(self,
        ...
        super(WebhookNotificationWithStreamConditionsRequest, self).__init__(id_=id_, resolve=resolve, resource_id=resource_id, triggered_at=triggered_at, type_=type_, event_type=event_type, category=category, resource_type=resource_type, muted=muted, custom_data=custom_data, url=url)
