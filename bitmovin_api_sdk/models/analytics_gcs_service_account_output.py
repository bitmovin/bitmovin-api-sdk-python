...
class AnalyticsGcsServiceAccountOutput(AnalyticsOutput):
    ...
    def __init__(self,
        ...
        super(AnalyticsGcsServiceAccountOutput, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, acl=acl)
