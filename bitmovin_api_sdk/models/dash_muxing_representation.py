...
class DashMuxingRepresentation(DashRepresentation):
    @poscheck_model
    def __init__(self,
                 id_=None,
                 encoding_id=None,
        ...
        super(DashMuxingRepresentation, self).__init__(id_=id_)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(DashMuxingRepresentation, self), 'openapi_types'):
            types = getattr(super(DashMuxingRepresentation, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(DashMuxingRepresentation, self), 'attribute_map'):
            attributes = getattr(super(DashMuxingRepresentation, self), 'attribute_map')
    ...
    def encoding_id(self):
        ...
        :return: The encoding_id of this DashMuxingRepresentation.
        :rtype: string_types
        """
    ...
    def encoding_id(self, encoding_id):
        ...
        """Sets the encoding_id of this DashMuxingRepresentation.

        UUID of an encoding (required)

        :param encoding_id: The encoding_id of this DashMuxingRepresentation.
        :type: string_types
        """
    ...
    def muxing_id(self):
        ...
        :return: The muxing_id of this DashMuxingRepresentation.
        :rtype: string_types
        """
    ...
    def muxing_id(self, muxing_id):
        # type: (string_types) -> None
        """Sets the muxing_id of this DashMuxingRepresentation.

        UUID of a muxing (required)

        :param muxing_id: The muxing_id of this DashMuxingRepresentation.
        :type: string_types
        """
    ...
    def dependency_id(self):
        ...
        :return: The dependency_id of this DashMuxingRepresentation.
        :rtype: string_types
        """
    ...
    def dependency_id(self, dependency_id):
        # type: (string_types) -> None
        """Sets the dependency_id of this DashMuxingRepresentation.

        Used to signal a dependency with another representation. The representation may belong to a different adaptation set

        :param dependency_id: The dependency_id of this DashMuxingRepresentation.
        :type: string_types
        """
    ...
    def to_dict(self):
        ...
        if hasattr(super(DashMuxingRepresentation, self), "to_dict"):
            result = super(DashMuxingRepresentation, self).to_dict()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DashMuxingRepresentation):
            return False
