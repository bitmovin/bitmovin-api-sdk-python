...
class SimpleEncodingLiveJobS3RoleBasedCredentials(SimpleEncodingLiveJobCredentials):
    @poscheck_model
    def __init__(self,
                 role_arn=None,
                 use_external_id=None):
        # type: (string_types, bool) -> None
        super(SimpleEncodingLiveJobS3RoleBasedCredentials, self).__init__()
    ...
    def openapi_types(self):
        ...
        if hasattr(super(SimpleEncodingLiveJobS3RoleBasedCredentials, self), 'openapi_types'):
            types = getattr(super(SimpleEncodingLiveJobS3RoleBasedCredentials, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(SimpleEncodingLiveJobS3RoleBasedCredentials, self), 'attribute_map'):
            attributes = getattr(super(SimpleEncodingLiveJobS3RoleBasedCredentials, self), 'attribute_map')
    ...
    def role_arn(self):
        ...
        :return: The role_arn of this SimpleEncodingLiveJobS3RoleBasedCredentials.
        :rtype: string_types
        """
    ...
    def role_arn(self, role_arn):
        ...
        """Sets the role_arn of this SimpleEncodingLiveJobS3RoleBasedCredentials.

        Amazon ARN of the IAM Role (Identity and Access Management Role) that will be assumed for S3 access. More details can be found [here](https://bitmovin.com/docs/encoding/api-reference/sections/inputs#/Encoding/PostEncodingInputsS3RoleBased) (required)

        :param role_arn: The role_arn of this SimpleEncodingLiveJobS3RoleBasedCredentials.
        :type: string_types
        """
    ...
    def use_external_id(self):
        ...
        :return: The use_external_id of this SimpleEncodingLiveJobS3RoleBasedCredentials.
        :rtype: bool
        """
    ...
    def use_external_id(self, use_external_id):
        # type: (bool) -> None
        """Sets the use_external_id of this SimpleEncodingLiveJobS3RoleBasedCredentials.

        Defines if the organization ID has to be used as externalId when assuming the role. More details can be found [here](https://bitmovin.com/docs/encoding/api-reference/sections/inputs#/Encoding/PostEncodingInputsS3RoleBased)

        :param use_external_id: The use_external_id of this SimpleEncodingLiveJobS3RoleBasedCredentials.
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        if hasattr(super(SimpleEncodingLiveJobS3RoleBasedCredentials, self), "to_dict"):
            result = super(SimpleEncodingLiveJobS3RoleBasedCredentials, self).to_dict()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SimpleEncodingLiveJobS3RoleBasedCredentials):
            return False
