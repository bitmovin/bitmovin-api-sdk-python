...
class MarlinDrm(Drm):
    ...
    def __init__(self,
        ...
        super(MarlinDrm, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, outputs=outputs)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(MarlinDrm, self), 'openapi_types'):
            types = getattr(super(MarlinDrm, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(MarlinDrm, self), 'attribute_map'):
            attributes = getattr(super(MarlinDrm, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(MarlinDrm, self), "to_dict"):
