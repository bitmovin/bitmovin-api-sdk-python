...
class AnalyticsAzureOutput(AnalyticsOutput):
    ...
    def __init__(self,
        ...
        super(AnalyticsAzureOutput, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, acl=acl)
