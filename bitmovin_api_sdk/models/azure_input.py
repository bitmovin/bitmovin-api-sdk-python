...
class AzureInput(Input):
    ...
    def __init__(self,
        ...
        super(AzureInput, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(AzureInput, self), 'openapi_types'):
            types = getattr(super(AzureInput, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(AzureInput, self), 'attribute_map'):
            attributes = getattr(super(AzureInput, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(AzureInput, self), "to_dict"):
