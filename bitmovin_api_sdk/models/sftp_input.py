...
class SftpInput(Input):
    ...
    def __init__(self,
                 ...
                 username=None,
                 password=None):
        # type: (string_types, string_types, string_types, datetime, datetime, dict, string_types, int, bool, string_types, string_types) -> None
        super(SftpInput, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data)
