...
class GenericS3Input(Input):
    ...
    def __init__(self,
                 ...
                 access_key=None,
                 secret_key=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, string_types, string_types, int, bool, S3SignatureVersion, string_types, string_types) -> None
        super(GenericS3Input, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(GenericS3Input, self), 'openapi_types'):
            types = getattr(super(GenericS3Input, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(GenericS3Input, self), 'attribute_map'):
            attributes = getattr(super(GenericS3Input, self), 'attribute_map')
