...
class FrameIdId3Tag(Id3Tag):
    ...
    def __init__(self,
        ...
        super(FrameIdId3Tag, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, position_mode=position_mode, frame=frame, time=time)
