...
class Cea608CaptionInputStream(InputStream):
    ...
    def __init__(self,
                 ...
                 input_path=None,
                 channel=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, string_types, string_types, Cea608ChannelType) -> None
        super(Cea608CaptionInputStream, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
