...
class WidevineDrm(Drm):
    ...
    def __init__(self,
        ...
        super(WidevineDrm, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, outputs=outputs)
