...
class WidevineDrm(Drm):
    ...
    def __init__(self,
        ...
        super(WidevineDrm, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, outputs=outputs)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(WidevineDrm, self), 'openapi_types'):
            types = getattr(super(WidevineDrm, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(WidevineDrm, self), 'attribute_map'):
            attributes = getattr(super(WidevineDrm, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(WidevineDrm, self), "to_dict"):
            result = super(WidevineDrm, self).to_dict()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WidevineDrm):
            return False
