...
class GcsServiceAccountOutput(Output):
    ...
    def __init__(self,
        ...
        super(GcsServiceAccountOutput, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, acl=acl)
