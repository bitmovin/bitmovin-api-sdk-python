...
class PlayReadyDrm(Drm):
    ...
    def __init__(self,
        ...
        # type: (string_types, string_types, string_types, datetime, datetime, dict, list[EncodingOutput], string_types, string_types, string_types, string_types, PlayReadyEncryptionMethod, string_types, PlayReadyAdditionalInformation) -> None
        super(PlayReadyDrm, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, outputs=outputs)
