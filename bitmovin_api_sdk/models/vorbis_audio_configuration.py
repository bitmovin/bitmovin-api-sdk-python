...
class VorbisAudioConfiguration(AudioConfiguration):
    ...
    def __init__(self,
                 ...
                 rate=None,
                 channel_layout=None):
        # type: (string_types, string_types, string_types, datetime, datetime, dict, int, float, VorbisChannelLayout) -> None
        super(VorbisAudioConfiguration, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, bitrate=bitrate, rate=rate)
