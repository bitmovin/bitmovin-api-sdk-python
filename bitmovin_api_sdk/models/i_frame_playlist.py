...
class IFramePlaylist(BitmovinResource):
    ...
    def __init__(self,
        ...
        super(IFramePlaylist, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(IFramePlaylist, self), 'openapi_types'):
            types = getattr(super(IFramePlaylist, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(IFramePlaylist, self), 'attribute_map'):
            attributes = getattr(super(IFramePlaylist, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(IFramePlaylist, self), "to_dict"):
