...
class FileInputStream(InputStream):
    ...
    def __init__(self,
                 ...
                 input_path=None,
                 file_type=None):
        # type: (string_types, string_types, string_types, datetime, datetime, dict, string_types, string_types, FileInputStreamType) -> None
        super(FileInputStream, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data)
