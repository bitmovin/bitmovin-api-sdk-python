...
class AdAnalyticsStddevQueryRequest(AdAnalyticsQueryRequest):

    def to_dict(self):
        """Returns the model properties as a dict"""
        result = {}

        if hasattr(super(AdAnalyticsStddevQueryRequest, self), "to_dict"):
            result = super(AdAnalyticsStddevQueryRequest, self).to_dict()
        return result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdAnalyticsStddevQueryRequest):
            return False
