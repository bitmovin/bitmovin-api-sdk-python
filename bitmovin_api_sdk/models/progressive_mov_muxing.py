...
class ProgressiveMovMuxing(Muxing):
    ...
    def openapi_types(self):
        ...
        if hasattr(super(ProgressiveMovMuxing, self), 'openapi_types'):
            types = getattr(super(ProgressiveMovMuxing, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(ProgressiveMovMuxing, self), 'attribute_map'):
            attributes = getattr(super(ProgressiveMovMuxing, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(ProgressiveMovMuxing, self), "to_dict"):
