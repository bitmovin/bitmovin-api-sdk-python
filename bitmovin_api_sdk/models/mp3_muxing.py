...
class Mp3Muxing(Muxing):
    ...
    def __init__(self,
        ...
        super(Mp3Muxing, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, streams=streams, outputs=outputs, avg_bitrate=avg_bitrate, min_bitrate=min_bitrate, max_bitrate=max_bitrate, ignored_by=ignored_by, stream_conditions_mode=stream_conditions_mode)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(Mp3Muxing, self), 'openapi_types'):
            types = getattr(super(Mp3Muxing, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(Mp3Muxing, self), 'attribute_map'):
            attributes = getattr(super(Mp3Muxing, self), 'attribute_map')
    ...
    def to_dict(self):
        ...
        if hasattr(super(Mp3Muxing, self), "to_dict"):
