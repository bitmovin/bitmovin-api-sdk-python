...
class DolbyVisionMetadataIngestInputStream(InputStream):
    ...
    def __init__(self,
                 ...
                 input_id=None,
                 input_path=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, string_types, string_types) -> None
        super(DolbyVisionMetadataIngestInputStream, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
