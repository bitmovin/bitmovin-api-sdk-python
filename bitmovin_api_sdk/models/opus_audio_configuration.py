...
class OpusAudioConfiguration(AudioConfiguration):
    ...
    def __init__(self,
                 ...
                 rate=None,
                 channel_layout=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, int, float, OpusChannelLayout) -> None
        super(OpusAudioConfiguration, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_, bitrate=bitrate, rate=rate)
