...
class Vp9PerTitleConfiguration(PerTitleConfiguration):
    ...
    def openapi_types(self):
        ...
        if hasattr(super(Vp9PerTitleConfiguration, self), 'openapi_types'):
            types = getattr(super(Vp9PerTitleConfiguration, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(Vp9PerTitleConfiguration, self), 'attribute_map'):
            attributes = getattr(super(Vp9PerTitleConfiguration, self), 'attribute_map')
