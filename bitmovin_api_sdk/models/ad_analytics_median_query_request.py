...
class AdAnalyticsMedianQueryRequest(AdAnalyticsQueryRequest):
    ...
    def to_dict(self):
        ...
        if hasattr(super(AdAnalyticsMedianQueryRequest, self), "to_dict"):
            result = super(AdAnalyticsMedianQueryRequest, self).to_dict()
        return result
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdAnalyticsMedianQueryRequest):
            return False
