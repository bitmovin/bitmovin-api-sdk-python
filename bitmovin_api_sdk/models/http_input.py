...
class HttpInput(Input):
    ...
    def __init__(self,
        ...
        super(HttpInput, self).__init__(id_=id_, name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data)
    ...
    def openapi_types(self):
        ...
        if hasattr(super(HttpInput, self), 'openapi_types'):
            types = getattr(super(HttpInput, self), 'openapi_types')
    ...
    def attribute_map(self):
        ...
        if hasattr(super(HttpInput, self), 'attribute_map'):
            attributes = getattr(super(HttpInput, self), 'attribute_map')
    ...
    def username(self):
        ...
        :return: The username of this HttpInput.
        :rtype: string_types
        """
    ...
    def username(self, username):
        # type: (string_types) -> None
        """Sets the username of this HttpInput.

        Basic Auth Username, if required

        :param username: The username of this HttpInput.
        :type: string_types
        """
    ...
    def password(self):
        ...
        :return: The password of this HttpInput.
        :rtype: string_types
        """
    ...
    def password(self, password):
        # type: (string_types) -> None
        """Sets the password of this HttpInput.

        Basic Auth Password, if required

        :param password: The password of this HttpInput.
        :type: string_types
        """
    ...
    def port(self):
        ...
        :return: The port of this HttpInput.
        :rtype: int
        """
        return self._port
    ...
    def port(self, port):
        # type: (int) -> None
        """Sets the port of this HttpInput.

        Custom Port

        :param port: The port of this HttpInput.
        :type: int
        """
    ...
    def to_dict(self):
        ...
        if hasattr(super(HttpInput, self), "to_dict"):
            result = super(HttpInput, self).to_dict()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HttpInput):
            return False
