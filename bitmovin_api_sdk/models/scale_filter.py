...
class ScaleFilter(Filter):
    ...
    def __init__(self,
        ...
        # type: (string_types, string_types, datetime, datetime, dict, string_types, int, int, ScalingAlgorithm, int, int) -> None
        super(ScaleFilter, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
