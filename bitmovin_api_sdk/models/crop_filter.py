...
class CropFilter(Filter):
    ...
    def __init__(self,
                 ...
                 bottom=None,
                 unit=None):
        # type: (string_types, string_types, datetime, datetime, dict, string_types, int, int, int, int, PositionUnit) -> None
        super(CropFilter, self).__init__(name=name, description=description, created_at=created_at, modified_at=modified_at, custom_data=custom_data, id_=id_)
