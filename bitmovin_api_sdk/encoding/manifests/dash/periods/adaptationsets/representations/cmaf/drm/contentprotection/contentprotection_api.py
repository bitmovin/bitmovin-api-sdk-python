...
from bitmovin_api_sdk.encoding.manifests.dash.periods.adaptationsets.representations.cmaf.drm.contentprotection.content_protection_list_query_params import ContentProtectionListQueryParams
...
class ContentprotectionApi(BaseApi):
    ...
    def create(self, manifest_id, period_id, adaptationset_id, representation_id, content_protection, **kwargs):
        ...
        :param content_protection: The content protection to be added to the DRM CMAF representation
        ...
        return self.api_client.post(
            '/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/cmaf/drm/{representation_id}/contentprotection',
            content_protection,
    ...
    def delete(self, manifest_id, period_id, adaptationset_id, representation_id, contentprotection_id, **kwargs):
        ...
        :param representation_id: Id of the representation
        :type representation_id: string_types, required
        :param contentprotection_id: Id of the DRM CMAF content protection to be deleted
        :type contentprotection_id: string_types, required
        :return: Id of the DRM CMAF Representation Content Protection
        :rtype: BitmovinResponse
        """

        return self.api_client.delete(
            '/encoding/manifests/dash/{manifest_id}/periods/{period_id}/adaptationsets/{adaptationset_id}/representations/cmaf/drm/{representation_id}/contentprotection/{contentprotection_id}',
    ...
    def get(self, manifest_id, period_id, adaptationset_id, representation_id, contentprotection_id, **kwargs):
        ...
        :param representation_id: Id of the representation
        :type representation_id: string_types, required
        :param contentprotection_id: Id of the DRM CMAF content protection
        :type contentprotection_id: string_types, required
        :return: DRM CMAF Representation Content Protection details
        :rtype: ContentProtection
        """
    ...
    def list(self, manifest_id, period_id, adaptationset_id, representation_id, query_params=None, **kwargs):
        ...
        :return: List of DRM CMAF Representation Content Protections
        :rtype: ContentProtection
        """
