...
from bitmovin_api_sdk.encoding.encodings.muxings.progressive_webm.drm.cenc.cenc_drm_list_query_params import CencDrmListQueryParams
...
class CencApi(BaseApi):
    ...
    def create(self, encoding_id, muxing_id, cenc_drm, **kwargs):
        ...
        :param cenc_drm: The CENC DRM to be created
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/drm/cenc',
            cenc_drm,
