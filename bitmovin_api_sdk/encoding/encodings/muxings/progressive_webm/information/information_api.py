...
class InformationApi(BaseApi):
    ...
    def get(self, encoding_id, muxing_id, **kwargs):
        # type: (string_types, string_types, dict) -> ProgressiveWebmMuxingInformation
        ...
        :return: Progressive WebM muxing Information
        :rtype: ProgressiveWebmMuxingInformation
        """

        return self.api_client.get(
            '/encoding/encodings/{encoding_id}/muxings/progressive-webm/{muxing_id}/information',
