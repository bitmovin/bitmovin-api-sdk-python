...
from bitmovin_api_sdk.encoding.encodings.muxings.ts.drm.speke.speke_drm_list_query_params import SpekeDrmListQueryParams
...
class SpekeApi(BaseApi):
    ...
    def create(self, encoding_id, muxing_id, speke_drm, **kwargs):
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/muxings/ts/{muxing_id}/drm/speke',
            speke_drm,
