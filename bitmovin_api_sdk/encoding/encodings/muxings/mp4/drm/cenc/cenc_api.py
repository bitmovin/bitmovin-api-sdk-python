...
from bitmovin_api_sdk.encoding.encodings.muxings.mp4.drm.cenc.cenc_drm_list_query_params import CencDrmListQueryParams
...
class CencApi(BaseApi):
    ...
    def create(self, encoding_id, muxing_id, cenc_drm, **kwargs):
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/muxings/mp4/{muxing_id}/drm/cenc',
            cenc_drm,
