...
class CustomdataApi(BaseApi):
    ...
    def get(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """Widevine DRM Custom Data of an CMAF muxing
        ...
        :return: Widevine DRM custom data
        :rtype: CustomData
        """

        return self.api_client.get(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/widevine/{drm_id}/customData',
