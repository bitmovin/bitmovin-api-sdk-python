...
from bitmovin_api_sdk.encoding.encodings.muxings.cmaf.drm.speke.speke_drm_list_query_params import SpekeDrmListQueryParams
...
class SpekeApi(BaseApi):
    ...
    def create(self, encoding_id, muxing_id, speke_drm, **kwargs):
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/speke',
            speke_drm,
    ...
    def delete(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """Delete SPEKE DRM from an CMAF muxing
        ...
        return self.api_client.delete(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/speke/{drm_id}',
    ...
    def get(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """SPEKE DRM Details of an CMAF muxing
    ...
    def list(self, encoding_id, muxing_id, query_params=None, **kwargs):
        ...
        """List SPEKE DRM of an CMAF muxing
