...
from bitmovin_api_sdk.encoding.encodings.muxings.cmaf.drm.fairplay.customdata.customdata_api import CustomdataApi
from bitmovin_api_sdk.encoding.encodings.muxings.cmaf.drm.fairplay.fair_play_drm_list_query_params import FairPlayDrmListQueryParams
...
class FairplayApi(BaseApi):
    ...
    def create(self, encoding_id, muxing_id, fair_play_drm, **kwargs):
        ...
        """Add FairPlay DRM to an CMAF muxing
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/fairplay',
            fair_play_drm,
    ...
    def delete(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """Delete FairPlay DRM from an CMAF muxing
        ...
        return self.api_client.delete(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/fairplay/{drm_id}',
    ...
    def get(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """FairPlay DRM Details of an CMAF muxing
    ...
    def list(self, encoding_id, muxing_id, query_params=None, **kwargs):
        ...
        """List FairPlay DRMs of an CMAF muxing
