...
class CustomdataApi(BaseApi):
    ...
    def get(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """FairPlay DRM Custom Data of an CMAF muxing
        ...
        :return: Fair Play custom data
        :rtype: CustomData
        """

        return self.api_client.get(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/fairplay/{drm_id}/customData',
