...
from bitmovin_api_sdk.encoding.encodings.muxings.cmaf.drm.marlin.customdata.customdata_api import CustomdataApi
from bitmovin_api_sdk.encoding.encodings.muxings.cmaf.drm.marlin.marlin_drm_list_query_params import MarlinDrmListQueryParams
...
class MarlinApi(BaseApi):
    ...
    def create(self, encoding_id, muxing_id, marlin_drm, **kwargs):
        ...
        """Add Marlin DRM to an CMAF muxing
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/marlin',
            marlin_drm,
    ...
    def delete(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """Delete Marlin DRM from an CMAF muxing
        ...
        return self.api_client.delete(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/marlin/{drm_id}',
    ...
    def get(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """Marlin DRM Details of an CMAF muxing
    ...
    def list(self, encoding_id, muxing_id, query_params=None, **kwargs):
        ...
        """List Marlin DRMs of an CMAF muxing
