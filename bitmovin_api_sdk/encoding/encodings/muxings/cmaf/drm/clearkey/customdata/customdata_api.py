...
class CustomdataApi(BaseApi):
    ...
    def get(self, encoding_id, muxing_id, drm_id, **kwargs):
        ...
        """ClearKey DRM Custom Data of an CMAF muxing
        ...
        :return: ClearKey DRM custom data
        :rtype: CustomData
        """

        return self.api_client.get(
            '/encoding/encodings/{encoding_id}/muxings/cmaf/{muxing_id}/drm/clearkey/{drm_id}/customData',
