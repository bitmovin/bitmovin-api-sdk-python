...
from bitmovin_api_sdk.encoding.encodings.muxings.progressiveTs.drm.fairplay.fair_play_drm_list_query_params import FairPlayDrmListQueryParams
...
class FairplayApi(BaseApi):
    ...
    def create(self, encoding_id, muxing_id, fair_play_drm, **kwargs):
        ...
        return self.api_client.post(
            '/encoding/encodings/{encoding_id}/muxings/progressive-ts/{muxing_id}/drm/fairplay',
            fair_play_drm,
