...
class CustomdataApi(BaseApi):
    ...
    def get(self, encoding_id, stream_id, nexguard_id, **kwargs):
        ...
        :param nexguard_id: Id of the nexguard file marker watermarking configuration.
        :type nexguard_id: string_types, required
        :return: Nexguard watermarking configuration custom data
        :rtype: CustomData
        """

        return self.api_client.get(
            '/encoding/encodings/{encoding_id}/streams/{stream_id}/watermarking/nexguard-file-marker/{nexguard_id}/customData',
