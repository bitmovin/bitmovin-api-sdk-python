...
class LiveManifestReadyApi(BaseApi):
    @poscheck_except(2)
    def __init__(self, api_key, tenant_org_id=None, base_url=None, logger=None):
        # type: (str, str, str, BitmovinApiLoggerBase) -> None

        super(LiveManifestReadyApi, self).__init__(
            api_key=api_key,
    ...
    def create(self, webhook, **kwargs):
        ...
        :param webhook: The &#39;Live Manifest Ready&#39; Webhook to be added.
    ...
    def delete_by_encoding_id_and_webhook_id(self, encoding_id, webhook_id, **kwargs):
        ...
        return self.api_client.delete(
            '/notifications/webhooks/encoding/encodings/{encoding_id}/live-manifest-ready/{webhook_id}',
    ...
    def delete_by_webhook_id(self, webhook_id, **kwargs):
        ...
        return self.api_client.delete(
            '/notifications/webhooks/encoding/encodings/live-manifest-ready/{webhook_id}',
    ...
    def list(self, query_params=None, **kwargs):
        ...
        :return: List of 'Live Manifest Ready' Webhooks
        :rtype: Webhook
        """
