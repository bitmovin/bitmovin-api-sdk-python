...
class CustomdataApi(BaseApi):
    ...
    def get_custom_data_by_encoding_id_and_webhook_id(self, encoding_id, webhook_id, **kwargs):
        ...
        return self.api_client.get(
            '/notifications/webhooks/encoding/encodings/{encoding_id}/live-encoding-heartbeat/{webhook_id}/customData',
    ...
    def get_custom_data_by_webhook_id(self, webhook_id, **kwargs):
        ...
        return self.api_client.get(
            '/notifications/webhooks/encoding/encodings/live-encoding-heartbeat/{webhook_id}/customData',
